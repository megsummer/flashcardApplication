...
INSERT INTO decks (user_id, deck_title, deck_description) VALUES (2, 'Renaissance Art Midterm', 'Study Guide for midterm art 2300');
INSERT INTO decks (user_id, deck_title, deck_description) VALUES (1, 'Lacrosse', 'Lacross terms, rules, and history');
INSERT INTO decks (user_id, deck_title, deck_description) VALUES (1, 'Software Developer Interview Questions', 'Prepare for your upcoming interview!');
